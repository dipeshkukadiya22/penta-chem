            ...
            <div class="content-header row">
                <div class="content-header-left col-md-9 col-12 mb-2">
                    <div class="row breadcrumbs-top">
                        <div class="col-12">
                            <h2 class="content-header-title float-start mb-0">Technical Specifications Title</h2>
                            <div class="breadcrumb-wrapper">
                                <ol class="breadcrumb">
                                    <li class="breadcrumb-item"><a href="#">Home</a>
                                    </li>
                                    <li class="breadcrumb-item"><a href="#">Technical Specifications Title</a>
                                    </li>
                                </ol>
                            </div>
                        </div>
                                    ...
                                    <div class="accordion-item">
                                        <h2 class="accordion-header" id="headingBorderOne">
                                            <button class="accordion-button collapsed" type="button"
                                                ...
                                                Add New Technical Specifications Title
                                            </button>
                                        </h2>
                                        <div id="accordionBorderOne" class="accordion-collapse collapse"
                                            ...
                                            <div class="accordion-body">
                                                <form class="needs-validation" method="POST"
                                                    ...
                                                    @csrf
                                                    <div class="row g-1">
                                                        <div class="col-md-5 col-12 mb-3 position-relative">
                                                            <label class="form-label"
                                                                for="validationTooltip01">Specifications Title</label>
                                                            <input type="text" class="form-control" name="category_name"
                                                                id="validationTooltip01" placeholder="Specifications Title"
                                                                required="">
                                                        ...
                                                        <div class="col-md-5 col-12 mb-3 position-relative">
                                                            ...
                                                            <input type="text" class="form-control" name="remark"
                                                                id="validationTooltip02" placeholder="Remarks">
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="">
                                                        ...
                                                        <a href="javascript:void(0)" class="edit-btn" data-id="{{ $item->id }}" data-bs-toggle="modal" data-bs-target="#editProductSubCategory">
...
<!--begin::Modal - Edit Product Sub Category-->
<div class="modal fade" id="editProductSubCategory" tabindex="-1" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered modal-lg">
        <div class="modal-content rounded">
            <!-- Modal Header -->
            <div class="modal-header border-0 pb-0">
                <h5 class="modal-title">Edit Technical Specifications Title</h5>
                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
            </div>

            <!-- Modal Body -->
            <div class="modal-body px-4">
                <form method="POST" id="productcategory" class="form edit-form" action="{{ route('productcategory.edit') }}">
                    @csrf
                    <input type="hidden" class="form-control" name="id" id="edit_id" required>

                    <!-- Category Name Field -->
                    <div class="mb-3 mt-3">
                        <label class="form-label edit-label" for="edit_category_name" >Specifications Title</label>
                        <input type="text" class="form-control" name="edit_category_name" id="edit_category_name" placeholder="Enter Specifications Title" required>
                    </div>
...
<!--End::Modal - Edit Product Sub Category>-->
...
<script>
    $(document).ready(function () {
        ...
        /* Delete Product category with with confirmation dialog*/
        $(".delete-btn").click(function () {
            ...
            Swal.fire({
                    ...
                    if (result.isConfirmed) {
                        ...
                        $.ajax({
                            url: "/productcategory/destroy/" + categoryId,
                            type:'GET',
                            success:function(response){
                                Swal.fire(
                                    'Deleted!',
